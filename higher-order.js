...
//Code Here
let evenNumbers = []
mixedNumbers.filter(function(e, i, a){
  if (e % 2 === 0){
  evenNumbers.push(e)    
  }
})
...
//Code Here
let myStrongest = []
monstersInYourPocket.filter(function(e,i,a){
  if (e.CP > 200){
    myStrongest.push(e)
  }
  return myStrongest
...
let bobsTotal;
bobPurchases = purchases.filter(function(e,i,a){
  if(e.owner === 'Bob'){
    return e
  }
})
...
bobPrices = bobPurchases.map(function(e,i,a){
  return e.price
})

bobPrices.reduce(function(acc, curr){
  bobsTotal = acc + curr
  return bobsTotal
})
